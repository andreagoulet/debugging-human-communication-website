...
whatYoullLearn:
  ...
  intro: "This isn't a lecture. It's a hands-on debugging session."
  items:
...
workshopDetails:
  title: "Work Through Your Real Challenges — Live"
  ...
  painPoints:
    - "Constantly being misunderstood no matter how clearly you explain"
    - "Putting in your best work and still having to fight for recognition"
    - "Spending more energy crafting the message than doing the actual work"
    - "Giving careful, thoughtful feedback that still gets taken the wrong way"
    - "Walking into rooms full of people and leaving feeling more alone than ever"
    - "Presenting clear evidence and still having to sell people on what it means"
    - "Laying out the data perfectly and stakeholders still can't see the story"
    - "Knowing exactly what needs to happen while you watch nothing change"
  reframe: "These are fixable bugs in your human communication system."
  transition: "Stop carrying these problems and start solving them. That's exactly what this workshop is for — live debugging on your communication challenges."
  itemsTitle: "You'll walk away with:"
  items:
    - "A clear map of where your communication system is breaking down"
    - "A concrete experiment you can run in your very next conversation"
    - "A personalized 3-month game plan"
    - "A room full of peers who think the way you do"
contrast:
  notItems:
...
imagine:
  title: "What the Upgrade Looks Like"
