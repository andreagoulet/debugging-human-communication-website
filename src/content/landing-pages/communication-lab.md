...
hero:
  ...
  ctaHeading: "Curious if it's a fit? Book a call to learn more."
  ...
  loop:
    stages:
      - name: "Decompose Problems"
        description: "Tiny tweaks can have big results. Andrea breaks down big challenges into their component parts so you can test and observe."
      - name: "Create an Experiment"
        description: "Interactions are tiny experiments. Andrea uses the scientific method to name variables, form hypotheses, and measure results."
...
whatYouGet:
  ...
  items:
    - title: "Weekly Coaching Sessions"
      description: "Talk through challenges, connect with peers, and design experiments in Andrea's virtual communication labs."
    - title: "Private Discord Community"
      description: "Get feedback, support, and cheers by keeping the conversation going on Discord between weekly labs."
...
cta:
  ...
  paragraphs:
    - "Chances are, you've got questions. If you're interested in learning more about how the Communication Lab works and whether it's the right fit for you, use the calendar below to chat with Andrea directly."
