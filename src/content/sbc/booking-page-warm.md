...
notASalesCall:
  title: "This is NOT a Sales Call"
  paragraphs:
    - "Let me be clear on this:"
    - "This call is purely a conversation to get to know you as a person and get to know your goals and challenges to see if they align with the approach I teach and the community I've built."
    - "Before making any kind of offer to you, I'd like to allow you to experience the workshop for yourself."
    - "And even after that, I'll only make you an offer if you tell me you want to go deeper."
  callout: "This call you're about to schedule is NOT a sales call."
...
faq:
  ...
  questions:
    ...
    - question: "Will I need to pay to attend?"
      answer: "Nope! Your first workshop experience is complimentary."
    - question: "Is there going to be a pitch?"
      answer: "You cannot buy anything during this workshop. It's going to be 100% value."
...
# Warm Guest Pass Landing Page

Content for the warm traffic landing page at /sbc-warm. Edit the frontmatter above to update the website. Video script is in video-script-warm.md.
